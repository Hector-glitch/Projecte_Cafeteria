...
class BegudesAdapter(val context: Context, val dataset: List<Begudes>, private val sharedViewModel: OrderSharedViewModel) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BegudesAdapter.BegudesViewHolder {
